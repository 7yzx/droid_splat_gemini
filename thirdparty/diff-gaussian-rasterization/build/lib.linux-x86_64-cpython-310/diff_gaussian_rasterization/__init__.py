...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, alpha, depth, mdepth, radii, geomBuffer, binningBuffer, imgBuffer, n_touched = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, mdepth, n_touched

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_mdepth, grad_n_touched):
